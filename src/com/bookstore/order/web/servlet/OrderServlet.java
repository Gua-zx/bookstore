...
import com.bookstore.order.domin.OrderItem;
...
public class OrderServlet extends BaseServlet {
	...
	public String zhiFu(HttpServletRequest request, HttpServletResponse response)
		...
		String p1_MerId = props.getProperty("p1_MerId");//商户编号  商户在易宝支付系统的唯一身份标识
		...
		String p8_Url = props.getProperty("p8_Url");//商户接收支付成功数据的地址  支付成功后易宝支付会向该地址发送两次成功通知，该地址可以带参数
		String p9_SAF = "";// 送货地址
		String pa_MP = "";//商户扩展信息
